...
<div class=" h-48 bg-gray-50 flex items-center">
    ...
    <div class="w-11/12 h-7/8 py-5 flex-col mx-auto justify-between">
        ...
        <div class="text-center font-gab md:text-3xl text-xl">Are You Looking For?</div>

        <div class="md:grid md:grid-cols-4 md:gap-24 mt-12 grid grid-cols-2 gap-6 font-roboto">
            ...
            <div class="flex items-center border-t-2 border-r-2 hover:border-t-0 tracking-wider
                hover:border-r-0 hover:border-b-2 hover:border-l-2 hover:bg-[#19398A] hover:text-white rounded-lg text-md
                scale-100 hover:scale-110 hover:skew-x-3 duration-300  py-1">
                <x-icons.icon icon="gift-top" class="w-6 h-6" />
                <div class="pl-2 w-full">Moment</div>
            </div></a>
