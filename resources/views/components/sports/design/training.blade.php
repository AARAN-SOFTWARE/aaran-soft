...
<section class="bg-white dark:bg-gray-900 mt-12">
    <div class="container w-10/12 px-6 py-10 mx-auto">
        <div class="lg:flex lg:items-center">
            ...
            <div class="w-full space-y-12 lg:w-1/2 ">
                <div>
                    @foreach($testimony as $row)
                        ...
                        <div class="relative inline-flex">
                            <span
                                class="absolute inset-x-0 bottom-0 border-b-[30px] border-[#4ADE80] opacity-65 animate__animated wow animate__backInLeft"
                                data-wow-duration="3s"></span>
                            <h1 class="relative text-4xl font-lexanddeca  font-bold text-black sm:text-6xl lg:text-7xl animate__animated wow animate__backInDown "
                                data-wow-duration="2s">
                                {{$row->vname}}</h1>
                        </div>

                        <h1 class="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl dark:text-white animate__animated wow animate__backInDown"
                            data-wow-duration="2s">
                            &nbsp;&nbsp;&nbsp;&nbsp;{{$row->description}}
                        </h1>


                        <div class="mt-2 animate__animated wow animate__backInDown" data-wow-duration="3s">
                ...
                @foreach($testimonyData as $row)
                    <div class="md:flex md:items-start md:-mx-4  animate__animated wow animate__backInDown"
                         data-wow-duration="2s">
                    <span class="inline-block p-2 text-blue-500 rounded-xl md:mx-4 dark:text-white dark:bg-blue-500">
                        {!! $row->icon !!}
                    </span>
            ...
            <div
                class="hidden lg:flex lg:items-center lg:w-1/2 lg:justify-center  animate__animated wow animate__backInDown"
                data-wow-duration="4s">
                @foreach($testimony as $row) @endforeach
