<section>
    <div class="py-10 bg-gradient-to-r from-fuchsia-600 to-blue-600">
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <h2 class="text-3xl font-bold leading-tight text-center text-white sm:text-4xl lg:text-5xl">You’ll be in great place</h2>
        </div>
    </div>
    ...
    <div class="grid grid-cols-4 md:grid-cols-6 xl:grid-cols-11">
        ...
        <div>
            <div class="aspect-w-1 aspect-h-1">
                <img class="bg-gray-200" src="{{ URL(\Illuminate\Support\Facades\Storage::url('images/'.$row->student_photo))}}" alt="logo" />
            </div>
        </div>
        @endforeach
{{--        <div>--}}
