<div class="bg-gradient-to-b from-green-50 to-green-100 animate__animated wow animate__slideInUp"  data-wow-duration="3s">
        ...
        <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
            <div class="grid items-center grid-cols-1 md:grid-cols-2">
                <div>
                    ...
                    <p class="mt-4 text-xl text-gray-600 md:mt-8  animate__animated wow animate__backInLeft"  data-wow-duration="2s">
                ...
                <div class="relative">
                    <img class="absolute inset-x-0 bottom-0 -mb-48 -translate-x-1/2 left-1/2  animate__animated wow animate__slideInRight"
                         src="https://cdn.rareblocks.xyz/collection/celebration/images/team/1/blob-shape.svg" alt="" />

                    <img class="relative w-full xl:max-w-lg xl:mx-auto 2xl:origin-bottom 2xl:scale-110  animate__animated wow animate__slideInLeft"  data-wow-duration="3s"
