...
<div class="grid md:grid-cols-3 grid-cols-1 mt-4 justify-items-center gap-6 font-roboto ">
        ...
        <div class="w-full bg-white rounded-3xl px-2 py-4 hover:bg-white-50 hover:shadow-md hover:shadow-gray-400 cursor-pointer ">
            <div class="w-[95%] mx-auto rounded-3xl flex justify-between">
                ...
                <div class="w-60 flex items-center">
                    <img src="{{ $row->user->profile_photo_url }}" alt="" class="w-8 h-8 rounded-full">
                    <div class="pl-2">
    ...
    {{--                    <div class="text-xs text-gray-500">mythical_jerry</div>--}}
            ...
            <!-- Image -->
            <div>
                <a href="{{ route('feed.show',[$row->id]) }}">
                    <img src="{{ \Illuminate\Support\Facades\Storage::url($row->image)}}" alt="" class="w-[95%] h-60 mt-4 mx-auto rounded-3xl">
                </a>
            </div>

            <div class="w-[95%] mt-2 mx-auto text-sm "><a href="{{ route('feed.show', $row->id) }}"> {!! (nl2br(e(Str::words($row->vname, '18')))) !!} </a></div>
            ...
            <div class="w-[95%]  mx-auto flex justify-between ">
                <div class="flex w-28 justify-between">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 text-pink-600" style="display: none" id="toggleFill">
