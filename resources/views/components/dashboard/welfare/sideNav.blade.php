<div class="w-1/5 flex-col flex gap-y-8 mt-5 font-roboto text-black">
    <a href="{{ route('dashboard') }}" class="flex-col mx-auto">
    ...
    <a href="{{ route('explore') }}" class="flex-col mx-auto">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-7 mr-2">
            <path fill-rule="evenodd" d="M10.5 3.75a6.75 6.75 0 1 0 0 13.5 6.75 6.75 0 0 0 0-13.5ZM2.25 10.5a8.25 8.25 0 1 1 14.59 5.28l4.69 4.69a.75.75 0 1 1-1.06 1.06l-4.69-4.69A8.25 8.25 0 0 1 2.25 10.5Z" clip-rule="evenodd" />
        </svg>
        <div class="text-xs ">Explore</div>
    </a>
    <a href="{{ route('feed') }}" class="flex-col mx-auto">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-7 mr-2">
