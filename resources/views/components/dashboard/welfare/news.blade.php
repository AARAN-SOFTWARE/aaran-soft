        ...
        <div
            ...
            <div class="p-4 md:p-5">
                ...
                <p class="mt-2 text-gray-500 dark:text-neutral-400">
                    Total Turnover : {{$transaction['no_of_shares']}}
                </p>

                <p class="mt-2 text-gray-500 dark:text-neutral-400">
                    This month : {{$transaction['total_investment']}}
                </p>

                <p class="mt-2 text-gray-500 dark:text-neutral-400">
                    This month : {{$transaction['total_dividend']}}
                </p>

                <p class="mt-2 text-gray-500 dark:text-neutral-400">
                    This month : {{$transaction['total_percent']}}
                </p>
