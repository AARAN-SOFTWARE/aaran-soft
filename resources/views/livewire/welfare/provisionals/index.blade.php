<div>
    <x-slot name="header">Project Provisional</x-slot>
            ...
            <x-slot name="table_body">
                @forelse ($list as $index =>  $row)
                    ...
                    <x-table.row>
                        ...
                        <x-table.cell-text>
                            {{ \Aaran\Welfare\Models\ProjectProvisional::project_name($row->projects_id)}}
                        </x-table.cell-text>

                        <x-table.cell-text>
                            {{ \Aaran\Welfare\Models\ProjectProvisional::product_name($row->project_product_id)}}
                        </x-table.cell-text>
