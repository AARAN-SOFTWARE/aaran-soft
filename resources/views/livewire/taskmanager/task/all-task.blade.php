        ...
        @forelse ($list as $index=> $row)
            ...
            <div class="border border-gray-400 w-full flex h-44">
                ...
                <div class="w-1/12 flex-col">
                    ...
                    <div
                        class="flex items-center justify-center h-1/4 border border-gray-400  {{ \App\Enums\Status::tryFrom($row->status)->getStyle() }}">
                ...
                <div class="flex-col w-full p-5">
                    ...
                    <div class="h-1/4 flex justify-between ">
                        <div class="w-full">
                            <a href="{{ route('tasks.show',[$row->id]) }}"
