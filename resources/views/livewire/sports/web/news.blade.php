<div>
    ...
    <div class="md:w-7/12 w-11/12 flex-col mx-auto pt-24 ">
        ...
        <div class="inline-flex items-center gap-2"><span class="text-sm text-red-700 my-2">Published - </span><span
                class="text-gray-400 text-xs md:pr-6"> {{$row->created_at}} </span> <span class="text-sm border-l border-gray-300 pl-6 text-red-700 my-2">Updated - </span><span
                class="text-gray-400 text-xs"> {{$row->updated_at}} </span></div>
        <img src="{{URL(\Illuminate\Support\Facades\Storage::url($row->image))}}" alt="" class="w-full my-6 md:h-[30rem] h-96 rounded-md shadow-md shadow-gray-400">
