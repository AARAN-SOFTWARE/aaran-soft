    ...
    <div class="bg-white py-6 sm:py-8 lg:py-12">
        <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
            ...
            <div class="mb-10 md:mb-16">
                <h2 class="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-6 lg:text-3xl">Registration Form</h2>
...
{{--                <p class="mx-auto max-w-screen-md text-center text-gray-500 md:text-lg">This is a section of some simple filler text, also known as placeholder text. It shares some characteristics of a real written text but is random or otherwise generated.</p>--}}
            ...
            <form class="mx-auto grid max-w-screen-md gap-4 sm:grid-cols-2">
                ...
                <div>
                    <label for="company" class="mb-2 inline-block text-sm text-gray-800 sm:text-base">Master_Name</label>
                ...
                <div>
                    <label for="address_1" class="mb-2 inline-block text-sm text-gray-800 sm:text-base">Address_1*</label>
                    <input name="address_1" class="w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring" />
                </div>

                <div>
                    <label for="address_2" class="mb-2 inline-block text-sm text-gray-800 sm:text-base">Address_2*</label>
                    <input name="address_2" class="w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring" />
                </div>
                ...
                <div>
                    ...
                    <input name="state" class="w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring" />
                </div>

                <div class="sm:col-span-2">
                    <label for="pin_code" class="mb-2 inline-block text-sm text-gray-800 sm:text-base">Pin_code*</label>
                    <input name="pin_code" class="w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring" />
                </div>
