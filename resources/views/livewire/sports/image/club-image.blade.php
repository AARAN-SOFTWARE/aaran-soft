<div>
    <x-slot name="header">Club Image</x-slot>
    ...
    <x-forms.m-panel>
        ...
        <x-forms.table :list="$list">
            <x-slot name="table_header">
                ...
                <x-table.header-text class="w-20" center>Club Image</x-table.header-text>
                    ...
                    <div class="flex">
                        ...
                        <div class="flex-shrink-0">
                            ...
                            <div>
                                @if($club_image)
                                    <div class="flex-shrink-0 ">
                                        <img class="h-24 w-full" src="{{ $club_image->temporaryUrl() }}"
                                             alt="{{$club_image?:''}}"/>
                                    </div>
                                @endif

                                @if(!$club_image && isset($old_club_image))
                                    <img class="h-24 w-full"
                                         src="{{URL(\Illuminate\Support\Facades\Storage::url('images/'.$old_club_image))}}"
                                         alt="">
                    ...
                    <div class="relative">
                        ...
                        <div>
                            <label for="club_image"
                                ...
                                <input type="file" id='club_image' wire:model="club_image" class="hidden"/>
