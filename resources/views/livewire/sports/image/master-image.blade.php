<div>
    <x-slot name="header">Master Image</x-slot>
    ...
    <x-forms.m-panel>
        ...
        <x-forms.table :list="$list">
            <x-slot name="table_header">
                ...
                <x-table.header-text class="w-32" center>Master Image</x-table.header-text>
                <x-table.header-text center wire:click.prevent="sortBy('title')" left>Title</x-table.header-text>
                    ...
                    <div class="flex">
                        ...
                        <div class="flex-shrink-0">
                            ...
                            <div>
                                @if($master_image)
                                    <div class="flex-shrink-0 ">
                                        <img class="h-24 w-full" src="{{ $master_image->temporaryUrl() }}"
                                             alt="{{$master_image?:''}}"/>
                                    </div>
                                @endif

                                @if(!$master_image && isset($old_master_image))
                                    <img class="h-24 w-full"
                                         src="{{URL(\Illuminate\Support\Facades\Storage::url('images/'.$old_master_image))}}"
                                         alt="">
                    ...
                    <div class="relative">
                        ...
                        <div>
                            <label for="master_image"
                                ...
                                <input type="file" id='master_image' wire:model="master_image" class="hidden"/>
                                <p class="text-xs font-light text-gray-400 mt-2">PNG, JPG SVG, WEBP, and GIF are
                                    Allowed.</p>
                            </label>
                        </div>

                        <div wire:loading wire:target="master_image" class="z-10 absolute top-6 left-12">
