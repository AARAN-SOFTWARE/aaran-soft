...
{{--                                            <div class="text-6xl font-bold">Title Go's Here</div>--}}
{{--                                            <div class="text-3xl  tracking-widest ">--}}
{{--                                                <p>--}}
{{--                                                    Human activity has been found to be the reason why a host of large--}}
{{--                                                    animals have gone extinct in the last 50,000 years. Climate change has often been blamed for--}}
{{--                                                    these animals vanishing from the face of Earth.--}}
{{--                                                </p>--}}
{{--                                            </div>--}}
{{--                                            <div>--}}
{{--                                                <button--}}
{{--                                                    class="h-12 w-48 rounded-2xl bg-green-500 hover:bg-green-800 text-lg font-bold text-white">--}}
{{--                                                    Hover me!--}}
{{--                                                </button>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
