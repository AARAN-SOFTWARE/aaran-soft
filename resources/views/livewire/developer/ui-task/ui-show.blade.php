                ...
                <div class="lg:flex flex-col gap-3">
                    <div class=" ">
                        ...
                        <div class="flex justify-between mt-5">
                            ...
                            <div class="h-32">
                                <a class="cursor-pointer capitalize font-serif text-4xl px-2 hover:underline underline-offset-8">
                                    {{ $vname }}
                                </a>
                            </div>
                            ...
                            <div class="text-center h-80">
                                <div>
                                    <button wire:click="fullImage()">
                                        <img class="w-[35rem] h-80 transition duration-300 ease-in-out bg-no-repeat hover:scale-110" src="{{ URL(\Illuminate\Support\Facades\Storage::url('images/'.$ui_pic)) }}" alt="">
                                    </button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="border-b border-gray-200 py-2 flex">
                                ...
                                <div class="h-20 w-20 mt-2 relative overflow-hidden bg-cover bg-no-repeat">
                                    <button wire:click="fullView('{{$row->id}}')">
                                        <img
                                            class=" rounded-xl h-20 w-20 transition duration-300 ease-in-out hover:scale-110 "
