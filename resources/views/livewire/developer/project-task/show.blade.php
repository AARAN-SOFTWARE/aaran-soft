<div>
    <x-slot name="header">Project Show</x-slot>
                                ...
                                <div class="flex flex-row  justify-between">
                                    ...
                                    <div class="px-3 flex flex-row justify-between">
                                        ...
                                        <div class="flex flex-row gap-2">
                                            ...
                                            <span
                                                class=" text-md text-gray-600">{{\Aaran\Developer\Models\ProjectTask::allocated($allocated) }}</span>
                                    ...
                                    {{$commentsCount}}
                                        ...
                                        <div class="p-1">
                                            <a
                                                class="cursor-pointer px-3 text-center rounded-full outline outline-1 outline-green-600 bg-green-100">{{ \App\Enums\Priority::tryFrom($priority)->getName() }}</a>
                                        </div>
                                    </div>
            ...
            <div class="h-40 w-40 lg:mr-8">
                <button wire:click="fullView()">
                    <img
                        ...
                        src="{{ URL(\Illuminate\Support\Facades\Storage::url('images/'.$old_task_pic)) }}"></button>
            </div>
