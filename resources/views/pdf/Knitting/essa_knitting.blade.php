...
{{--  /* Invoice table data and Total */ --}}
    <table class="table-3" width="100%">
        <tr class="inv-tableHeader">
            ...
            <th width="auto" colspan="2">Particulars</th>
            <th width="8.33%">HSN Code</th>
            <th width="6.33%">No of Rolls</th>
            <th width="4.33%">Kgs</th>
        ...
        @foreach($list as $index => $row)
                <tr class="inv-tableData1">
                    ...
                    <td class="items-c">{{$row['no_of_roll']}} </td>
        ...
        <tr >
            ...
            <td colspan="4"  class="sign-col2" width="250px"  style="vertical-align: top; ">for&nbsp;<span class="auth">{{$cmp->get('company_name')}}</span></td>
        </tr>
        <tr>
