...
<table width="100%">
    ...
    <tr>
        ...
        <td style="text-align:right"><b>{{number_format($totalPurchase+$opening_balance,2,'.','')}}</b></td>
        <td style="text-align:right"><b>{{number_format($totalPayment,2,'.','')}}</b></td>
    </tr>
    <tr>
        <td colspan="4" style="text-align: right;"><b>Balance</b></td>
        <td style="text-align:right"><b>{{number_format($totalPurchase+$opening_balance-$totalPayment,2,'.','')}}</b></td>
        <td></td>
    </tr>
    </tbody>
</table>
